	          ...
	          <table class="table table-striped table-condensed">
	            <tbody>
	              <tr>
	                ...
	                <td class="center"><textarea name="txtdesc" class="autogrow"><?php echo $data['data1'][0]['Description'];?></textarea></td>
                  </tr>
	              <tr>
	              ...
	              <tr>
	                ...
	                <td class="control-group success"><input name="price" class="input-small warning" id="inputWarning" type="text" value="<?php echo $data['data1'][0]['Dollar_Price'];?>"></td>
                  </tr>
	              <tr>
	                ...
	                <td class="control-group warning"><input name="coins" class="input-small warning" id="inputWarning" type="text" value="<?php echo $data['data1'][0]['Coin_Price'];?>"></td>
                  </tr>
	              <tr>
	                ...
	                <td class="center"><input type="text" name="startdate" class="input-small datepicker" id="date01" value="<?php echo $data['data1'][0]['Start_Date'];?>"></td>
                  </tr>
	              <tr>
	                ...
	                <td class="center"><input type="text" name="enddate" class="input-small datepicker" id="date02" value="<?php echo $data['data1'][0]['End_Date'];?>"></td>
                  </tr>
	              <tr>
	                ...
	                <td class="center"><textarea name="textarea" rows="15" class="cleditor" id="textarea2"><p>$99 for an Italian dinner for four with one bottle of Merlot Reserve  Michael Sullberg, Gabbiano chianti, Pinot Grigio Serenissima, or  Terranoble Chardonnay (up to a $38 value; up to a $217.40 total value)</p>
          <ul>
