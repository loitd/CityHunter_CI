...
<div class="page-header">
  <h1><?php echo $data['basic'][0]['Internal_ID'];?> <small>Edit Sales Rep Account</small></h1>
  </div>
			...
			<table class="table table-striped table-condensed">
				  <tbody>
					<tr>
						...
						<input name="internalID" class="input-small error" id="inputError" type="text" value="<?php echo $data['basic'][0]['Internal_ID'];?>"></td>
						<td class="center">&nbsp;</td>
					</tr>
					<tr>
					  <td><strong>Unique ID</strong></td>
					  <td class="controls"><input class="input-mini disabled" id="uniqueid" type="text" placeholder="<?php echo $data['basic'][0]['id'];?>" disabled=""></td>
					  <td class="center">&nbsp;</td>
				    </tr>
					<tr>
						<td><strong>First Name</strong></td>
						<td class="controls">
						<input name="firstname" class="input-medium" type="text" value="<?php echo $data['basic'][0]['First_Name'];?>"></td>
						<td class="center">&nbsp;</td>
					</tr>
					<tr>
						<td><strong>Last Name</strong></td>
						<td class="controls">
						<input name="lastname" class="input-medium" type="text" value="<?php echo $data['basic'][0]['Last_Name'];?>"></td>
						<td class="center">&nbsp;</td>
					</tr>
					<tr>
						<td><strong>Email</strong></td>
						<td class="control-group warning">
						<input name="email" class="input-large warning" id="inputWarning" type="text" value="<?php echo $data['basic'][0]['Email'];?>"></td>
						<td class="center">&nbsp;</td>
					</tr>
					<tr>
					...
					<tr>
					  <td><strong>Phone</strong></td>
						<td class="controls">
						<input name="phone" class="input-medium" type="text" value="<?php echo $data['basic'][0]['Phone'];?>"></td>
					  <td class="center">&nbsp;</td>
				    </tr>                                   
				  </tbody>
		  </table>  
				  ...
				  <div class="form-actions">
					<button name="staffupdate" type="submit" class="btn btn-primary" onclick="return savestaffnote()">Save Changes</button>
    ...
    <div class="box-content">
      ...
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane active" id="notes">
          <textarea name="textarea" rows="3" class="cleditor" id="textarea2">
